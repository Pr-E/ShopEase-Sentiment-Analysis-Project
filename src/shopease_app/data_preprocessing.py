...
from config.constant import Input_Data, model_name, truncation, max_length, padding, Train_Data, Test_Data
...
def prepare_sentiment_data():
    try:
        ...
        logging.info(f"Data successfully prepared.")
